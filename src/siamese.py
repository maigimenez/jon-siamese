...
class Siamese:
    def __init__(self, sequence_length, vocab_size, embedding_size, filter_sizes, num_filters,
                 margin=1.5, threshold=1.0, fully=False, hash_size=64):
        ...
        with tf.device('/gpu:0'):
            ...
            with tf.name_scope("similarity"):
                self.label = tf.placeholder(tf.int32, [None, 1], name='label')  # 1 if same, 0 if different
